...
parser.add_argument('--data', type=str, default=r'D:\Downloads\FER-dataset')
parser.add_argument('--data_type', default='FER-dataset', choices=['FER-dataset'],
...
def main():
    ...
    # create model
    model = pyramid_trans_expr2(img_size=224, num_classes=5)
...
def validate(val_loader, model, criterion, args):
    ...
    with torch.no_grad():
        for i, (images, target) in enumerate(val_loader):
            ...
            C = metrics.confusion_matrix(y_ture, y_pred, labels=[0, 1, 2, 3, 4])
            D += C
